...
import com.curso.jpa.libraryapi.repository.specs.LivroSpecs;
import com.curso.jpa.libraryapi.security.SecurityService;
import com.curso.jpa.libraryapi.validator.LivroValidator;
...
import static com.curso.jpa.libraryapi.repository.specs.LivroSpecs.*;
...
public class LivroService {
    ...
    public void atualizar(Livro livro) {
        if(livro.getId() == null){
            throw new IllegalArgumentException("Para atualizar, é necessário que o livro já esteja cadastrado na base");
        }
        validator.validar(livro);

...
import com.curso.jpa.libraryapi.security.CustomAuthentication;
...
public class AuthorizationServerConfiguration {
    ...
    public AuthorizationServerSettings authorizationServerSettings(){
        return AuthorizationServerSettings.builder()
                //obter token
                .tokenEndpoint("/oauth2/token") //padrão
                //para consultar status do token
                .tokenIntrospectionEndpoint("/oauth2/introspect") //padrão
                //revogar
                .tokenRevocationEndpoint("/oauth2/revoke") //padrão

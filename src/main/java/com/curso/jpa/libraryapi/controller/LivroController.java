...
import com.curso.jpa.libraryapi.controller.dto.CadastroLivroDTO;
import com.curso.jpa.libraryapi.controller.dto.ResultadoPesquisaLivroDTO;
import com.curso.jpa.libraryapi.controller.mappers.LivroMapper;
import com.curso.jpa.libraryapi.model.GeneroLivro;
import com.curso.jpa.libraryapi.model.Livro;
import com.curso.jpa.libraryapi.service.LivroService;
...
public class LivroController implements GenericController {
    ...
    @DeleteMapping("{id}")
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE')")
    @Operation(summary = "Deletar", description = "Deletar um livro existente")
    @ApiResponses({
    ...
    @GetMapping
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE')")
    @Operation(summary = "Pesquisar", description = "Pesquisar livro por parâmetros")
    @ApiResponses({
    ...
    @PutMapping("{id}")
    @PreAuthorize("hasAnyRole('OPERADOR', 'GERENTE')")
    @Operation(summary = "Atualizar", description = "Atualiar livro existente")
    @ApiResponses({
